function calculate(baseatk, basedef, basesta, league, floor, minLvl, maxLvl, invalid) {
  ...
  /* console.log("calculat3: Received: baseatk="+baseatk+" basedef="+basedef+" basesta="+basesta+" league="+league+" floor="+floor+" minLvl="+minLvl); */
  ...
  /* console.log("calculat3 output:"+JSON.stringify(sorted, null, 2)); */
  return sorted;
}